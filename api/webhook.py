    ...
    def do_POST(self):
        ...
        if "message" in update and "text" in update["message"]:
            ...
            if "youtube.com" in text or "youtu.be" in text:
                try:
                    send_telegram_message(chat_id, "Pray, wait a moment while I procure your recording with the utmost diligence... 🎩⏳")
                    ...
                    with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                        ...
                        if not best_video_url or not best_audio_url:
                            raise Exception("I struggled to find a suitable format for this recording that would satisfy my quality standards.")
